...
import '../nurse/profile.dart';
import '../../widget/bottomNavigationBar.dart';
import '../../widget/remender_widget/medicine_card.dart';
import 'add_medicine_page.dart';

class NurseReminder extends StatefulWidget {
  static const String routeName = '/nurseremender';

  const NurseReminder({super.key});

  @override
  _NurseReminderAppState createState() => _NurseReminderAppState();
}

class _NurseReminderAppState extends State<NurseReminder> {
...
class _HomePageState extends State<remenderHomePage> {
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 0) {
      Navigator.pushNamed(context, NurseDetailsApp.routeName);
    }
  }
